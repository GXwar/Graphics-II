...
export const normarlizeToDevice = (height, width, normalized) => {
  ...
  for (var i = 0; i < normalized.faces.length; i++) {
    tryFillPoly(height, width, normalized.faces[i], dataset, normalized.points);
  }
  return dataset;
};

let prev = performance.now();
export const deviceRender = (height, width, ticks, ctx, dataset) => {
